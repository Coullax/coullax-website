...
export default function Construct(): JSX.Element {
  ...
  return (
    <div className="py-[2.211vh] md:py-[4.211vh] lg:py-[6.711vh] w-full bg-black">
      <div className=" w-[90%] max-w-[104.027vh] mx-auto">
        ...
        <div className="w-full flex flex-col lg:flex-row justify-between lg:items-start items-center">
          ...
          <h1 className="w-full !text-center lg:!text-left text-[3.219vh] lg:text-[6.443vh] md:text-[4.043vh] font-special-gothic-expanded-one md:leading-[7.477vh] -tracking-[0.215vh] md:-tracking-[0.322vh] uppercase text-white">
            constructs
          </h1>
