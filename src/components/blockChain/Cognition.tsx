  ...
  return (
    <div className=" w-full bg-white relative">
      ...
      <CognitionCoreTemplate
        ...
        titleTextClassName="w-full !text-center lg:!text-left text-[3.814vh] md:text-[6.443vh] font-special-gothic-expanded-one leading-[5.901vh] md:leading-[7.477vh] -tracking-[0.215vh] md:-tracking-[0.322vh] uppercase"
