...
export default function Construct(): JSX.Element {
  ...
  return (
    <div className="py-[2.211vh] md:py-[4.211vh] lg:py-[6.711vh] w-full bg-white">
      <div className=" w-[90%] max-w-[104.027vh] mx-auto">
        ...
        <div className="w-full flex flex-col lg:flex-row justify-between lg:items-start items-center">
          ...
          <h1 className="w-full !text-center lg:!text-left text-[3.219vh] lg:text-[6.443vh] md:text-[4.043vh] font-special-gothic-expanded-one md:leading-[7.477vh] -tracking-[0.215vh] md:-tracking-[0.322vh] uppercase text-black">
            constructs
          </h1>
          <h1 className=" w-full text-center lg:text-right text-[2.146vh] md:text-[2.416vh] font-special-gothic-expanded-one leading-[2.146vh] lg:leading-[2.805vh] -tracking-[0.043vh] md:-tracking-[0.121vh] uppercase text-black">
            services
          </h1>
        </div>
        ...
        <h1 className=" text-black font-silkscreen pt-[2.146vh] md:pt-[2.966vh] text-[0.644vh] md:text-[1.007vh] md:h-[6.081vh] leading-[1.309vh] uppercase">
          <TypingAnimation
            ...
            supportHTML={true}
            duration={10}
            className="text-[0.751vh] md:text-[1.271vh] lg:text-[1.007vh] w-full text-center lg:text-left leading-[0.966vh] md:leading-[1.309vh] font-silkscreen text-black"
          >
            {
        ...
        <div className=" mt-[3.219vh] md:mt-[4.237vh] lg:mt-[3.758vh] w-full text-black text-center lg:text-left text-[1.288vh] md:text-[1.864vh] lg:text-[2.685vh] uppercase font-inclusive-sans leading-[1.609vh] md:leading-[2.288vh] lg:leading-[3.49vh]">
        ...
        <div className="flex justify-center lg:justify-start my-[3.219vh] md:my-[4.237vh] lg:my-[3.356vh]">
          <BookCallBtn className="text-white bg-[#0505cb] leading-[1.315vh] -tracking-[0.067vh] border-black hover:bg-transparent hover:scale-105 hover:text-[#0505cb] hover:border-[#0505cb] transition-all duration-300 ease-in-out" />
        </div>
        ...
        <div className=" w-full mt-[2.711vh] md:mt-[4.711vh] lg:mt-[6.711vh] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[2.146vh] md:gap-[1.864vh] lg:gap-[1.342vh]">
          {constructsItems.map((item, index) => (
            <ConstructItemCard
              key={index}
              image={`/ai/construct/${item.image}_black.svg`}
              hoverImage={`/ai/construct/${item.image}_yellow.svg`}
              title1={item.title1}
              title2={item.title2}
...
const ConstructItemCard = ({
  ...
  return (
    <div className=" group p-[1.609vh] lg:p-[2.685vh] md:p-[1.685vh] min-h-[20.268vh] md:min-h-[30.268vh] lg:min-h-[40.268vh] flex flex-col justify-start bg-transparent border border-black overflow-hidden relative">
      {/* Animated background overlay on hover */}
      <div className=" h-[0px] group-hover:h-[201.342vh] transition-all duration-800 absolute bottom-0  left-0  bg-black w-full"></div>
      ...
      <div className=" mt-[3.785vh] md:mt-[5.785vh] lg:mt-[7.785vh] z-10">
        <h1 className="flex flex-col font-special-gothic-expanded-one text-[2.146vh] md:text-[2.085vh] lg:text-[2.685vh] leading-[2.575vh] md:leading-[2.49vh] lg:leading-[3.49vh] uppercase group-hover:text-white text-black">
          <span>{title1}</span>
          <span>{title2}</span>
        </h1>
        <div className=" font-inclusive-sans text-[1.395vh] leading-[1.609vh] lg:leading-[2.094vh] uppercase group-hover:text-white mt-[2.685vh] text-black">
          {description}
        </div>
      </div>
    </div>
