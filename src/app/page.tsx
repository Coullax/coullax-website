          ...
          <div className="flex flex-col justify-start items-start gap-[55px] p-0 md:my-[140px] my-[40px]">
            ...
            <div className="w-full flex md:flex-row flex-col md:items-start gap-[25px] p-0 justify-between items-center">
              <div className="min-w-[281px] w-full flex flex-col justify-start items-start px-[25px] py-[24px] rounded-[25px] bg-[#f3f8f8]">
                <span className="h-[23px] self-stretch flex-grow-0 font-[PlusJakartaSans] text-[20px] font-bold [font-stretch:normal] not-italic leading-[1.16] tracking-[-1px] text-left text-[#2c4a40] mb-[120px]">
                  Kickoff
                </span>
        ...
        <div className=" w-[90%] max-w-[1200px] mx-auto  ">
          <div className="w-[1198px] h-[783px] flex-grow-0 flex flex-col justify-start items-start gap-[60px] p-0">
            <div className="w-[570px] h-[156.1px] flex-grow-0 flex flex-col justify-between items-start p-0">
              <div className="w-[283.5px] h-[42.1px] flex-grow-0 flex flex-row justify-center items-center gap-[6.4px] px-[22.3px] py-[9.5px] rounded-[63.6px] bg-[#272626]"></div>
              <span className="w-[570px] h-[69px] flex-grow-0 font-[PlusJakartaSans] text-[20px] font-medium [font-stretch:normal] not-italic leading-[1.16] tracking-[normal] text-left text-[#575757]">
                {" "}
                Woarking with us is easy. We follow a clear, no fuss process
        ...
        <div className=" w-[90%] max-w-[1200px] mx-auto ">
          <div className="w-[1200px] h-[457.1px] flex-grow-0 flex flex-col justify-start items-center gap-[45px] mt-[140px]">
            ...
            <span className="w-[706px] h-[115px] flex-grow-0 font-[PlusJakartaSans] text-[20px] font-medium [font-stretch:normal] not-italic leading-[1.16] tracking-[normal] text-center text-[#575757] py-[45px]">
              ...
              a safer placeTo achieve this, we believe in the power of
